...
import ktp.elektronik.exceptions.NonexistentEntityException;
...
public class dataController {
    ...
    public RedirectView newDummyData(@RequestParam("gambar") MultipartFile f, Model m, HttpServletRequest r)
        ...
        String berlaku = r.getParameter("berlakuhinga");
    ...
    public String deleteData(@PathVariable("id") int id)  throws NonexistentEntityException, ktp.elektronik.exceptions.NonexistentEntityException {
    ...
    @RequestMapping("/edit/{id}")
       //@ResponseBody
       public String update(@PathVariable(value = "id") int id, Model model) throws NonexistentEntityException,  ktp.elektronik.exceptions.NonexistentEntityException {
       Data d = datactrl.findData(id);
