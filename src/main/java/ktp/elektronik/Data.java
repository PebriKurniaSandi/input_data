...
@NamedQueries({
    ...
    @NamedQuery(name = "Data.findByBerlakuhinga", query = "SELECT d FROM Data d WHERE d.berlakuhinga = :berlakuhinga")})
public class Data implements Serializable {
    ...
    @Basic(optional = false)
    @Column(name = "berlakuhinga")
    private String berlakuhinga;
    @Lob
    @Column(name = "foto")
    private byte[] foto;
    ...
    public Data(Integer id, String noktp, String nama, Date tgllahir, String jeniskelamin, String alamat, String agama, String status, String pekerjaan, String warganegara, String berlakuhinga) {
        this.id = id;
        this.noktp = noktp;
        this.nama = nama;
        ...
        this.berlakuhinga = berlakuhinga;
    }
    ...
    public String getBerlakuhinga() {
        return berlakuhinga;
    }

    public void setBerlakuhinga(String berlakuhinga) {
        this.berlakuhinga = berlakuhinga;
    }
    ...
    public String toString() {
        return "ktp.elektronik.Data[ id=" + id + " ]";
    }
